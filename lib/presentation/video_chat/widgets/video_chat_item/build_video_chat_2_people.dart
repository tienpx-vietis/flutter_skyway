      ...
      children: [
        Expanded(
          ...
          child: GestureDetector(
            onDoubleTap: () {
              viewModel.setVideoFullScreen(_buildLocalVideo());
              viewModel.isFullScreenEnabled = !viewModel.isFullScreenEnabled;
            },
            child: Padding(
        ...
        Expanded(
          ...
          child: GestureDetector(
            onTap: () {
              viewModel.setVideoFullScreen(_createRemoteView(viewModel.peers.keys.first));
              viewModel.isFullScreenEnabled = !viewModel.isFullScreenEnabled;
            },
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 4),
