...
class VideoChatView extends BaseView<VideoChatViewModel> {
                ...
                child: Row(
                  children: [
                    buildItemVideoChat(
                      ...
                      circleImage:
                          Assets.images.imgCircleAvartarPlaceHolder.image(width: 84, height: 84, fit: BoxFit.cover),
                    ),
                    buildItemVideoChat(
                      name: "You",
                      backgroundImage: Assets.images.imgAvatarPlaceHolder2.image(fit: BoxFit.cover),
  ...
  Expanded buildItemVideoChat({required String name, required Image backgroundImage, required Image circleImage}) {
    return Expanded(
      child: Padding(
